...
configurationRegistry.registerConfiguration({
	...
	properties: {
		...
		[ChatConfiguration.ThinkingTitleLanguage]: {
			type: 'string',
			default: 'auto',
			enum: ['auto', 'en', 'fr', 'it', 'de', 'es', 'ru', 'zh-CN', 'zh-TW', 'ja', 'ko', 'cs', 'pt-br', 'tr', 'pl'],
			enumDescriptions: [
				nls.localize('chat.agent.thinking.titleLanguage.auto', "Use VS Code's configured display language"),
				'English',
				'français',
				'italiano',
				'Deutsch',
			...
			description: nls.localize('chat.agent.thinking.titleLanguage', "Controls the language used for generated thinking section titles."),
			tags: ['experimental'],
		},
